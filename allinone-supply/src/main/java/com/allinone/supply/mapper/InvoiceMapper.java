...
public interface InvoiceMapper {
    List<Invoice> selectList(@Param("userId") Long userId,@Param("admin") boolean admin,@Param("invoiceNumber") String invoiceNumber,@Param("approvalStatus") String approvalStatus);
