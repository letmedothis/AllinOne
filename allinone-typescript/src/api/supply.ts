...
export function uploadDocumentAttachment(documentId: string | number, file: File, attachmentType = 'SUPPORTING') { const data = new FormData(); data.append('file', file); data.append('attachmentType', attachmentType); return request({ url: `/supply/documents/${documentId}/attachments`, method: 'post', data, headers: { 'Content-Type': 'multipart/form-data' } }) }
